...
public class DiaryResource
{
	...
	// }
	// };
	// private static final Parser<Versioned<String>> parserVersionedString = new
	// ParserVersioned<String>(
	// parserString);
	// private static final Serializer<Versioned<String>> serializerVersionedString = new
	// SerializerAdapter<Versioned<String>>(
