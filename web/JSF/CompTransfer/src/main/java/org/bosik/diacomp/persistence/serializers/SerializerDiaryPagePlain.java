...
public class SerializerDiaryPagePlain // implements Serializer<DiaryPage>
{
	...
	// private static final SerializerFoodMassedPlain foodSerializer = new
	// SerializerFoodMassedPlain();
	//
	// /**
	// * Загружает страницу из её текстового представления. При возникновении ошибок информирует
	// через
