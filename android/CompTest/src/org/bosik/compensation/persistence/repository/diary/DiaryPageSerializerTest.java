...
public class DiaryPageSerializerTest extends TestCase
{
	...
	private static DiaryPage demoPageA()
	{
	...
	private static DiaryPage demoPageB()
	{
		DiaryPage page = new DiaryPage();
	...
	private static void comparePages(DiaryPage expPage, DiaryPage actPage)
	{
		// check the header
	...
	{
		DiaryPage org = demoPageA();
		String source = org.writeFull();

		DiaryPage restored = DiaryPage.multiRead(source).get(0);
		comparePages(org, restored);
	}
}
