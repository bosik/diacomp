...
public class TestUtils extends TestCase
{
	...
	public void test_sumHash()
	{
		assertEquals("00000000000000000000000000000000",
				Utils.sumHash("00000000000000000000000000000000", "00000000000000000000000000000000"));
		assertEquals("22222222222222222222222222222222",
				Utils.sumHash("11111111111111111111111111111111", "11111111111111111111111111111111"));
		assertEquals("ffffffffffffffffffffffffffffffff",
				Utils.sumHash("88888888888888888888888888888888", "77777777777777777777777777777777"));
		assertEquals("00000000000000000000000000000000",
				Utils.sumHash("88888888888888888888888888888888", "88888888888888888888888888888888"));
	}

	public void test_subHash()
	{
		assertEquals("00000000000000000000000000000000",
				Utils.subHash("00000000000000000000000000000000", "00000000000000000000000000000000"));
		assertEquals("00000000000000000000000000000000",
				Utils.subHash("11111111111111111111111111111111", "11111111111111111111111111111111"));
		assertEquals("11111111111111111111111111111111",
				Utils.subHash("88888888888888888888888888888888", "77777777777777777777777777777777"));
		assertEquals("0000000000000000000000000000000f",
				Utils.subHash("00000000000000000000000000000000", "00000000000000000000000000000001"));
	}
