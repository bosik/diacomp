 ...
 */
package org.bosik.diacomp.web.frontend.wicket.pages.restore.sent;
...
public class RestoreSentPage extends MasterPage
{
	...
	public RestoreSentPage(IModel<String> model)
	{
		this.model = model;
	}
