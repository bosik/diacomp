...
const
  ...
  32.26, 44.62, 31.71, 49.71, 48, 48.62, 51.07, 45.6);
var
  i: integer;
begin
  Result := '';
...
const
  W: array[1..26] of single =
  (104.22, 115.86, 116.15, 112.27, 58.17, 46.84, 46.73, 117.86, 106.97, 45.79,
  99.26, 110.82, 108.98, 46.71, 99.3, 110.82, 109.22, 112.38, 100.99, 110.3,
  115.26, 96.62, 115.71, 104.71, 111, 109.62);
var
  i: integer;
begin
  Result := '';
...
begin
  ...
  LabelThanks.Caption :=
    'Яна Пилюгина (много ценных идей)'#13 +
