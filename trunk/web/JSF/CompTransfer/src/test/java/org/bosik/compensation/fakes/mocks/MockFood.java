...
public class MockFood implements Mock<Food>
{
	...
	public List<Food> getSamples()
	{
		...
		samples.add(food("���� \"��������\" ������� (JUnit test)", 5.5, 0.9, 44.1, 206.3));
		samples.add(food("�������", 0.9, 0.1, 9, 41));
		samples.add(food("������ \"����������\"", 0, 0, 15, 60));
		samples.add(food("������� �������� 3%", 2.9, 3, 4.5, 56));
		samples.add(food("����� \"� ���\" ��-2 (������� �����)", 7.4, 5.4, 51.2, 283));
		samples.add(food("��������� ������ ������� ��������� � �������� �������� \"���������\"", 4, 23, 27, 340));
		samples.add(food("����", 12.7, 11.5, 0.7, 157));
