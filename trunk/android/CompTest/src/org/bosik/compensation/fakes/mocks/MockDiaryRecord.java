...
public class MockDiaryRecord extends TestCase implements Mock<DiaryRecord>
{
	...
	public List<DiaryRecord> getSamples()
	{
		...
		samples.add(new BloodRecord(new Date(2012, 04, 18, 16, 42, 05), 7.1, 0));
		samples.add(new BloodRecord(new Date(2012, 04, 18, 16, 50, 28), 7.0, 1));
		samples.add(new BloodRecord(new Date(2012, 04, 18, 17, 00, 00), 5.2, 2));

		samples.add(new InsRecord(new Date(2012, 04, 18, 17, 20, 00), 16.0));

		MealRecord meal1 = new MealRecord(new Date(2012, 04, 18, 17, 25, 59), false);
		...
		MealRecord meal2 = new MealRecord(new Date(2012, 04, 18, 23, 59, 59), true);
		meal2.add(new FoodMassed("Сахар", 0.0, 0.0, 99.8, 379.0, 6.0));
		samples.add(meal2);

		MealRecord meal3 = new MealRecord(new Date(2012, 04, 18, 23, 59, 59), true);
		...
		samples.add(new MealRecord(new Date(2012, 04, 18, 0, 0, 0), true));

		samples.add(new NoteRecord(new Date(2014, 01, 01, 12, 00, 00), "Just a тестовая record with \"quotes\""));

		samples.add(new NoteRecord(new Date(2013, 12, 31, 23, 59, 59), ""));
