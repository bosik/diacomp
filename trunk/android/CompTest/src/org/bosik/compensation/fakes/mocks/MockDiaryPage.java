...
public class MockDiaryPage extends TestCase implements Mock<DiaryPage>
{
	...
	public List<DiaryPage> getSamples()
	{
		...
		DiaryPage page1 = new DiaryPage(new Date(2010, 10, 25), new Date(2010, 10, 25, 22, 15, 41), 64);
		...
		DiaryPage page2 = new DiaryPage(new Date(2010, 10, 26), new Date(2010, 10, 27, 00, 05, 59), 48);
		for (DiaryRecord rec : mockDiaryRecord.getSamples())
		{
			page2.add(rec);
			page2.add(rec);
