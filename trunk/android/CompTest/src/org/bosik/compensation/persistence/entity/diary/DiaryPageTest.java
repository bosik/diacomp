...
public class DiaryPageTest extends TestCase
{
	...
	// Calendar.getInstance().getTime(), 1, "*09:05 4,8");
	//
	...
	// {
	// DiaryPage d = new DiaryPage(Calendar.getInstance().getTime(),
	// Calendar.getInstance().getTime(), 1, "-09:05 7.9");
	//
	// assertEquals(1, d.count());
	// DiaryRecord r = d.get(0);
	 ...
	 * ((MealRecord)r).get(0).getRelValue()); assertEquals(2.5, ((MealRecord)r).get(0).getMass());
	 */
	// }
}
