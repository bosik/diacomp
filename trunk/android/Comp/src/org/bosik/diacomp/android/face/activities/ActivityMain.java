...
import org.bosik.diacomp.android.persistence.services.web.utils.client.WebClient.LoginResult;
...
import org.bosik.diacomp.android.services.sync.SyncBaseService;
import org.bosik.diacomp.android.services.sync.SyncBaseService.SyncResult;
import org.bosik.diacomp.android.services.sync.SyncDiaryService.Callback;
	...
	private class AsyncTaskAuthAndSync extends AsyncTask<SyncParams, Integer, LoginResult> implements Callback
	{
		...
		protected LoginResult doInBackground(SyncParams... par)
		{
			...
			try
			{
				...
				// syncPagesCount = SyncDiaryService.synchronize(Storage.localDiary,
				// Storage.webDiary,
				// since);
